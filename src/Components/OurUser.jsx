...
const OurUser = () => {
    return (
        <div className="mx-auto max-w-[1280px] my-10">
            <h1 className="font-bold uppercase lg:text-6xl text-4xl text-center  ">Our Users</h1>
            <div className="divider mt-2 mb-16 w-96 mx-auto"></div>
            <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 ">
                {/* card 1 */}
                
                    <div className="mb-10">
                        <div className="group relative cursor-pointer overflow-hidden bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
                            <span className="absolute top-10 z-0 h-20 w-20 rounded-full bg-[#2563DC] transition-all duration-300 group-hover:scale-[10]" />
                ...
                {/* card 2 */}
                    ...
                    <div className="mb-10">
                        <div className="group relative cursor-pointer overflow-hidden bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
                            <span className="absolute top-10 z-0 h-20 w-20 rounded-full bg-[#2563DC] transition-all duration-300 group-hover:scale-[10]" />
                            <div className="relative">
                                <span className="grid h-20 w-20 place-items-center rounded-full bg-[#2563DC] transition-all duration-300 group-hover:bg-amber-900">
                                    <img
                                        className="rounded-full"
                                        src="https://iili.io/JAfoLwg.jpg"
                                        alt=""
